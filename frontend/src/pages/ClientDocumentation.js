    ...
    <div style={{ ...darkBg, minHeight: '100vh', padding: '30px 20px' }}>
      <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '40px', flexWrap: 'wrap', gap: '20px' }}>
          <h1 style={{ margin: 0, fontSize: '32px', fontWeight: 'bold', color: '#fff' }}>ðŸ“„ Client Documentation</h1>
          <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
            <button onClick={() => { setShowAllCompanies(true); fetchAllCompanies(); }} style={{ padding: '10px 20px', background: '#4CAF50', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold' }}>ðŸ‘ï¸ View All Clients</button>
            {userRole === 'admin' && (
              <button onClick={() => { setShowRecycleBin(true); fetchRecycleBin(); }} style={{ padding: '10px 20px', background: '#f44336', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold' }}>ðŸ—‘ï¸ Recycle Bin</button>
            )}
            <button onClick={() => navigate(-1)} style={{ padding: '10px 20px', background: '#2196F3', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold' }}>â† Back</button>
          </div>
        </div>
        ...
        <div style={{ ...glassStyle, padding: '25px', marginBottom: '30px', background: 'linear-gradient(135deg, rgba(76, 175, 80, 0.15) 0%, rgba(76, 175, 80, 0.05) 100%)' }}>
          <h2 style={{ marginTop: 0, color: '#4CAF50', fontSize: '20px' }}>ðŸ›¡ï¸ Identicare Program</h2>
          ...
          <div style={{ background: 'rgba(255, 255, 255, 0.05)', padding: '15px', borderRadius: '8px', marginBottom: '15px' }}>
            <h3 style={{ marginTop: 0, color: '#4CAF50', fontSize: '16px' }}>ðŸ’¡ The 50% Rule</h3>
        ...
        <div style={{ ...glassStyle, padding: '25px', marginBottom: '30px' }}>
          <h2 style={{ marginTop: 0, color: '#fff', fontSize: '20px' }}>ðŸ“‹ Step-by-Step Guide</h2>
        ...
        <div style={{ ...glassStyle, padding: '25px', marginBottom: '30px' }}>
          <h2 style={{ marginTop: 0, color: '#fff', fontSize: '20px' }}>âž• Add Documentation</h2>
          ...
          <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
            <button onClick={() => setShowManualEntry(true)} style={{ padding: '10px 20px', background: '#2196F3', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold' }}>ðŸ“ Manual Entry</button>
            <button onClick={handleDownloadTemplate} style={{ padding: '10px 20px', background: '#4CAF50', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold' }}>ðŸ“‹ Download Template</button>
            {userRole === 'admin' && (
              <>
                <button onClick={() => setShowNewClient(true)} style={{ padding: '10px 20px', background: '#FF9800', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold' }}>âž• Create New Client</button>
              </>
            )}
          </div>
        </div>
        ...
        <div style={{ ...glassStyle, padding: '25px', marginBottom: '30px' }}>
          <h2 style={{ marginTop: 0, color: '#fff', fontSize: '20px' }}>ðŸ“Š View Documentation</h2>
          <div style={{ marginBottom: '20px' }}>
            ...
            <div style={{ display: 'flex', gap: '10px', alignItems: 'center', flexWrap: 'wrap' }}>
              ...
              {selectedCompanyViewDropdown && (
                <>
                  <button onClick={() => handleExportCompany(selectedCompanyViewDropdown)} style={{ padding: '10px 20px', background: '#4CAF50', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold', whiteSpace: 'nowrap' }}>ðŸ“¥ Export Company Summary</button>
                  <button onClick={() => handleGenerateCardUsageReport(selectedCompanyViewDropdown)} style={{ padding: '10px 20px', background: '#2196F3', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold', whiteSpace: 'nowrap' }}>ðŸ“Š View Card Usage Report</button>
                  <button onClick={() => { setSelectedCompanyForStaff(selectedCompanyViewDropdown); setShowCompanyStaffAssign(true); }} style={{ padding: '10px 20px', background: '#9C27B0', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold', whiteSpace: 'nowrap' }}>ðŸ‘¥ Assign Staff to Company</button>
                </>
              )}
            </div>
          </div>
                    ...
                    {companyDocuments.map(doc => (
                      <tr key={doc._id} style={{ borderBottom: '1px solid rgba(255, 255, 255, 0.1)' }}>
                        ...
                        <td style={{ padding: '15px', display: 'flex', gap: '5px', flexWrap: 'wrap' }}>
                          <button onClick={() => { setSelectedDoc(doc); setShowAddRemove(true); }} style={{ padding: '6px 10px', background: '#4CAF50', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer', fontSize: '12px', fontWeight: 'bold' }}>âž• Add</button>
                          <button onClick={() => { setSelectedDoc(doc); setShowAddRemove(true); setAddRemoveAction('remove'); }} style={{ padding: '6px 10px', background: '#FF5722', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer', fontSize: '12px', fontWeight: 'bold' }}>âž– Remove</button>
                          <button onClick={() => { setSelectedDoc(doc); setShowJobAssign(true); }} style={{ padding: '6px 10px', background: '#9C27B0', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer', fontSize: '12px', fontWeight: 'bold' }}>ðŸ’¼ Assign Job</button>
                          <button onClick={() => { setSelectedDoc(doc); fetchHistory(doc._id); setShowHistory(true); }} style={{ padding: '6px 10px', background: '#00BCD4', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer', fontSize: '12px', fontWeight: 'bold' }}>ðŸ“‹ History</button>
                          <button onClick={() => handleExport(doc._id)} style={{ padding: '6px 10px', background: '#2196F3', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer', fontSize: '12px', fontWeight: 'bold' }}>ðŸ“¥ Export</button>
                          <button onClick={() => handleDelete(doc._id)} style={{ padding: '6px 10px', background: '#f44336', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer', fontSize: '12px', fontWeight: 'bold' }}>ðŸ—‘ï¸ Delete</button>
                        </td>
                      </tr>
                    ))}
                  </tbody>
      ...
      {showCardUsageReport && cardUsageData && (
        <div style={modalStyle} onClick={() => setShowCardUsageReport(false)}>
          <div style={modalContentStyle} onClick={(e) => e.stopPropagation()}>
            <h2 style={{ marginTop: 0, color: '#fff' }}>ðŸ“Š Card Usage Report - {cardUsageData.companyName}</h2>
